...
import SidebarSkeleton from './skeltetons/SidebarSkeleton.jsx';
import { Users } from "lucide-react";
import { authStore } from '../store/useAuthStore.js';
const Sidebar = () => {
const {users , selectedUser , getUser , setSelectedUser , isUsersLoading} = chatStore();
...
if(isUsersLoading) <div>  <SidebarSkeleton/>  </div>
      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUsers.map((user) => (
          <button
            ...
            `}
          >
            <div className="relative rounded-full  mx-auto lg:mx-0">
              <img
